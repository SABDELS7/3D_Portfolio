...
export const clientReviews = [
  {
    ...
    review:
      'Working with Abderrahmane was a fantastic experience. He transformed our outdated website into a modern, user-friendly platform. His attention to detail and commitment to quality are unmatched. Highly recommend him for any web dev projects.',
  },
  {
    id: 2,
    name: 'Mark Rogers',
    ...
    review:
      'Abderrahmane’s expertise in web development is truly impressive. He delivered a robust and scalable solution for our e-commerce site, and our online sales have significantly increased since the launch. He’s a true professional! Fantastic work.',
  },
  {
    id: 3,
    name: 'John Dohsas',
    ...
    review:
      'I can’t say enough good things about Abderrahmane. He was able to take our complex project requirements and turn them into a seamless, functional website. His problem-solving abilities are outstanding.',
  },
  {
    id: 4,
    name: 'Ether Smith',
    ...
    review:
      'Abderrahmane was a pleasure to work with. He understood our requirements perfectly and delivered a website that exceeded our expectations. His skills in both frontend backend dev are top-notch.',
  },
];
...
export const workExperiences = [
  {
    ...
    title: "National School of Applied Sciences | Oujda, Engineering Program: Computer Engineering (CI).",
    icon: '/assets/ensa.png',
    animation: 'victory',
  },
  {
    id: 2,
    ...
    duration: '2021 - 2022',
    title: "National School of Applied Sciences | Oujda, Preparatory Program (STPI).",
    icon: '/assets/ensa.png',
    animation: 'clapping',
  },
  {
    ...
    pos: 'Student',
    duration: '2020 - 2021',
    title: "Baccalaureate in Physical Sciences | Salam High School | Oujda.",
    icon: '/assets/bacalaureat.png',
    animation: 'salute',
  },
];
